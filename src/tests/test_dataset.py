...
class TestDataset:
    def test_wildreceipt_dataset(self):
        ...
        test_set = Wildreceipt(train=False, img_folder="/home/bobmarley/PycharmProjects/DocumentAI-std/data/wildreceipt/",label_path = "/home/bobmarley/PycharmProjects/DocumentAI-std/data/wildreceipt/test.txt")
        print(train_set.data[0].to_json())
