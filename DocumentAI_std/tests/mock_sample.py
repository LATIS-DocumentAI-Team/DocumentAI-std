...
def mock_distances():
    return [
        (0, 0, 3, 4, 5, 7, 4),  # Example 1
        (1, 1, 4, 5, 6, 9, 4),  # Example 2
        (-1, -1, 2, 3, 4, 7, 3),  # Example 3
        (2, 2, 5, 6, 6, 9, 4),  # Example 4
        (-2, -2, 1, 2, 4, 7, 3),  # Example 5
        (3, 3, 6, 7, 7, 11, 4),  # Example 6
        (-3, -3, 0, 1, 5, 9, 3),  # Example 7
        (4, 4, 7, 8, 8, 15, 4),  # Example 8
        (-4, -4, -1, 0, 6, 11, 3),  # Example 9
        (5, 5, 8, 9, 9, 17, 4),  # Example 10
    ]
